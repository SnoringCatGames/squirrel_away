...
const A90_A45_EXTERIOR_JOINS := {
    ...
    left_wall_and_right_walls = {
        ...
        to_top_45_cap_and_bottom_45_cap = Vector2(7,22),
    },
...
func _forward_subtile_selection(
    ...
    var proximity := CellProximityV1.new(
            tile_map,
            self,
            cell_position,
            tile_id,
...
static func _choose_subtile(proximity: CellProximityV1) -> Vector2:
    if proximity.is_top_empty:
        if proximity.is_bottom_empty:
                    ...
                    if proximity.is_floor_with_45_curve_in_at_right:
                        if proximity.is_ceiling_with_45_curve_in_at_left:
                            if proximity.is_ceiling_with_45_curve_in_at_right:
                                return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_cap_and_right_45_cap
                            else:
                                return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_cap_and_right_45_neg
                        elif proximity.is_ceiling_with_45_curve_in_at_right:
                            return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_pos_and_right_45_cap
                        else:
                            return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_pos_and_right_45_neg
                    elif proximity.is_ceiling_with_45_curve_in_at_left:
                        if proximity.is_ceiling_with_45_curve_in_at_right:
                            return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_cap_and_right_45_pos
                        else:
                            return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_cap
                    elif proximity.is_ceiling_with_45_curve_in_at_right:
                        return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_pos_and_right_45_pos
                    else:
                        return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_pos
                elif proximity.is_floor_with_45_curve_in_at_right:
                    if proximity.is_ceiling_with_45_curve_in_at_left:
                        if proximity.is_ceiling_with_45_curve_in_at_right:
                            return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_neg_and_right_45_cap
                        else:
                            return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_neg_and_right_45_neg
                    elif proximity.is_ceiling_with_45_curve_in_at_right:
                        return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_right_45_cap
                    else:
                        return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_right_45_neg
                elif proximity.is_ceiling_with_45_curve_in_at_left:
                    if proximity.is_ceiling_with_45_curve_in_at_right:
                        return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_neg_and_right_45_pos
                    else:
                        return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_left_45_neg
                elif proximity.is_ceiling_with_45_curve_in_at_right:
                    return A90_A45_EXTERIOR_JOINS.floor_and_ceilings.to_right_45_pos
                else:
                    ...
                    if proximity.is_angle_type_90:
                        ...
                        if proximity.is_right_90_floor:
                            ...
                            if proximity.is_top_right_empty and \
                                    proximity.is_right_empty_at_right:
                ...
                if proximity.is_angle_type_90:
                    ...
                    if proximity.is_left_90_floor:
                        ...
                        if proximity.is_top_left_empty and \
                                proximity.is_left_empty_at_left:
            ...
            if proximity.is_bottom_left_empty:
                if proximity.is_bottom_right_empty:
                    ...
                    elif proximity.is_bottom_left_corner_concave_partial_45 or \
                            proximity.is_bottom_right_corner_concave_partial_45:
                    ...
                    elif proximity.is_bottom_left_corner_concave_45:
                ...
                elif proximity.is_bottom_right_corner_concave_partial_45:
        ...
        if proximity.is_left_empty:
            ...
            if proximity.is_top_left_empty:
                if proximity.is_top_right_empty:
                    ...
                    elif proximity.is_top_left_corner_concave_partial_45 or \
                            proximity.is_top_right_corner_concave_partial_45:
                    ...
                    elif proximity.is_top_left_corner_concave_partial_45:
                ...
                elif proximity.is_top_right_corner_concave_partial_45:
        ...
        if proximity.is_right_empty:
                ...
                if proximity.is_left_wall_with_45_curve_in_at_bottom:
                    if proximity.is_right_wall_with_45_curve_in_at_top:
                        if proximity.is_right_wall_with_45_curve_in_at_bottom:
                            return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_cap_and_bottom_45_cap
                        else:
                            return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_cap_and_bottom_45_pos
                    elif proximity.is_right_wall_with_45_curve_in_at_bottom:
                        return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_neg_and_bottom_45_cap
                    else:
                        return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_neg_and_bottom_45_pos
                elif proximity.is_right_wall_with_45_curve_in_at_top:
                    if proximity.is_right_wall_with_45_curve_in_at_bottom:
                        return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_cap_and_bottom_45_neg
                    else:
                        return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_cap
                elif proximity.is_right_wall_with_45_curve_in_at_bottom:
                    return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_neg_and_bottom_45_neg
                else:
                    return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_neg
            elif proximity.is_left_wall_with_45_curve_in_at_bottom:
                if proximity.is_right_wall_with_45_curve_in_at_top:
                    if proximity.is_right_wall_with_45_curve_in_at_bottom:
                        return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_pos_and_bottom_45_cap
                    else:
                        return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_pos_and_bottom_45_pos
                elif proximity.is_right_wall_with_45_curve_in_at_bottom:
                    return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_bottom_45_cap
                else:
                    return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_bottom_45_pos
            elif proximity.is_right_wall_with_45_curve_in_at_top:
                if proximity.is_right_wall_with_45_curve_in_at_bottom:
                    return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_pos_and_bottom_45_neg
                else:
                    return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_top_45_pos
            elif proximity.is_right_wall_with_45_curve_in_at_bottom:
                return A90_A45_EXTERIOR_JOINS.left_wall_and_right_walls.to_bottom_45_neg
            else:
            ...
            if proximity.is_top_right_empty:
                if proximity.is_bottom_right_empty:
                    ...
                    elif proximity.is_top_right_corner_concave_partial_45 or \
                            proximity.is_bottom_right_corner_concave_partial_45:
        ...
        if proximity.is_top_left_empty:
            if proximity.is_bottom_left_empty:
                if proximity.is_left_wall_with_45_curve_in_at_top:
                    ...
                    return A90_A45_EXTERIOR_JOINS.a90_sides_with_cutout_corners.left_walls.to_bottom_a45.both
                        ...
                        proximity.is_bottom_left_corner_concave_partial_45:
            ...
            elif proximity.is_bottom_left_corner_concave_partial_45:
        ...
        if proximity.is_top_left_empty:
            if proximity.is_top_right_empty:
                if proximity.is_bottom_left_empty:
                    if proximity.is_bottom_right_empty:
                        if proximity.is_any_corner_concave_partial_45:
                ...
                if proximity.is_top_left_corner_concave_partial_45:
                    if proximity.is_bottom_right_empty_at_bottom_or_right:
                        # FIXME: LEFT OFF HERE: ------------
                        # - Replace with a non-tile-type-specific check; instead, check for a 90-90 cutout IN THE NEIGHBOR.
                        ...
                        if proximity.is_top_left_corner_concave_90_vertical_to_45:
                            return A90_A45_EXTERIOR_JOINS.left_walls.bottom_45_concave
                        elif proximity.is_top_left_corner_concave_90_horizontal_to_45:
                            return A90_A45_EXTERIOR_JOINS.floors.right_45_concave
                        else:
            ...
            if proximity.is_bottom_left_empty:
                ...
                if proximity.is_top_right_corner_concave_partial_45:
                    if proximity.is_bottom_left_empty_at_bottom_or_left:
                        # FIXME: LEFT OFF HERE: ------------
                        # - Replace with a non-tile-type-specific check; instead, check for a 90-90 cutout IN THE NEIGHBOR.
                        ...
                        if proximity.is_top_right_corner_concave_90_vertical_to_45:
                            return A90_A45_EXTERIOR_JOINS.right_walls.bottom_45_concave
                        elif proximity.is_top_right_corner_concave_90_horizontal_to_45:
                            return A90_A45_EXTERIOR_JOINS.floors.left_45_concave
                        else:
            ...
            if proximity.is_bottom_right_empty:
                ...
                if proximity.is_bottom_left_corner_concave_partial_45:
                    if proximity.is_top_right_empty_at_top_or_right:
                        # FIXME: LEFT OFF HERE: ------------
                        # - Replace with a non-tile-type-specific check; instead, check for a 90-90 cutout IN THE NEIGHBOR.
                        ...
                        if proximity.is_bottom_left_corner_concave_90_vertical_to_45:
                            return A90_A45_EXTERIOR_JOINS.left_walls.top_45_concave
                        elif proximity.is_bottom_left_corner_concave_90_horizontal_to_45:
                            return A90_A45_EXTERIOR_JOINS.ceilings.right_45_concave
                        else:
            ...
            if proximity.is_bottom_right_corner_concave_partial_45:
                if proximity.is_top_left_empty_at_top_or_left:
                    # FIXME: LEFT OFF HERE: ------------
                    # - Replace with a non-tile-type-specific check; instead, check for a 90-90 cutout IN THE NEIGHBOR.
                    ...
                    if proximity.is_bottom_right_corner_concave_90_vertical_to_45:
                        return A90_A45_EXTERIOR_JOINS.right_walls.top_45_concave
                    elif proximity.is_bottom_right_corner_concave_90_horizontal_to_45:
                        return A90_A45_EXTERIOR_JOINS.ceilings.left_45_concave
                    else:
...
static func _choose_interior_subtile(proximity: CellProximityV1) -> Vector2:
    # FIXME: LEFT OFF HERE: ------------ Distinguish between 90 and 45 degrees according to neighbors.
    
    if proximity.is_top_empty_around_top:
        if proximity.is_bottom_empty_around_bottom:
            if proximity.is_left_empty_around_left:
                if proximity.is_right_empty_around_right:
            ...
            elif proximity.is_right_empty_around_right:
        ...
        elif proximity.is_left_empty_around_left:
            if proximity.is_right_empty_around_right:
                return A90_INTERIOR_SUBTILE_POSITIONS.exposed_sides.top_left_right
            else:
                if proximity.is_bottom_right_empty_around_bottom_right:
            ...
            if proximity.is_bottom_left_empty_around_bottom_left:
            ...
            elif proximity.is_bottom_right_empty_around_bottom_right:
    ...
    elif proximity.is_bottom_empty_around_bottom:
        if proximity.is_left_empty_around_left:
            if proximity.is_right_empty_around_right:
                return A90_INTERIOR_SUBTILE_POSITIONS.exposed_sides.bottom_left_right
            else:
                if proximity.is_top_right_empty_around_top_right:
            ...
            if proximity.is_top_left_empty_around_top_left:
            ...
            elif proximity.is_top_right_empty_around_top_right:
        ...
        elif proximity.is_bottom_left_empty_around_bottom_left:
        ...
        elif proximity.is_bottom_left_empty_at_bottom_left:
            if proximity.is_bottom_right_empty_around_bottom_right:
